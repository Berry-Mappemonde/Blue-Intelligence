// Lot R10a — évaluateur de plan (serveur). Aucun changement visible.
...
const shot = (page, name) => page.screenshot({
  path: `../docs/recette/lot-r10a/${name}.jpg`,
  type: "jpeg",
  quality: 70,
  fullPage: false,
});
...
test("lot R10a — aucun changement visible, trois parcours", async ({ page }) => {
