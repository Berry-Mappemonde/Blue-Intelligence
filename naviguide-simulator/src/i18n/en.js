...
export default {
  ...
  skipperOrdersTitle:     "Skipper orders",
  skipperProfileCoastal:  "Coastal",
  skipperProfileCruise:   "Cruise",
  skipperProfileOcean:    "Offshore",
  skipperSharedClock:     "The official clock does not change. It is your skipper who speaks more or less.",
  skipperBoat:            "Boat",
  ...
  skipperHorizon:         "Follow horizon",
  skipperHorizonLeg:      "this leg (Simulation)",
  skipperGale:            "Gale",
  skipperRainSuivre:      "Rain: {mmh} mm/h or {mm3h} mm/3 h → refuge within {nm} nm.",
  skipperRainSimulation:  "Rain and refuge: Follow only. No invented rain in Simulation.",
