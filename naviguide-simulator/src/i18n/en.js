...
export default {
  ...
  finish:             "Finish",
  importRoute:        "Import",
  importRouteReplace: "Replace the current route?",
  importRouteError:   "Unreadable file",
  ...
  storySourceSuper: "Nemotron 3 Super · Token Factory",
  storySourceUltra: "Nemotron 3 Ultra · Token Factory",
  storySourceOpenrouter: "OpenRouter",
  storySourceClaude: "Claude",
  storySourceRules: "rules",
  storySourceBudget: "budget",
  storySourceCache: "cache",
  ...
  journalKindClimo:    "Regime change",
  journalKindSci:      "Station passed",
  journalKindNews:     "Watch",
  journalClimoRose:    "Dominant wind shifted by {deg}°",
  journalClimoCalms:   "Shift to the doldrums (mean wind {kn} kn)",
  journalClimoCycloneIn: "Entering the cyclone season",
  journalClimoCycloneOut: "Leaving the cyclone season",
  journalSciNearby:    "Scientific station passed: {name} ({nm} nm)",
  journalWxHours:      "{h} h",
  journalWxMax:        "max {n}",
  journalWxLevelRough: "Rough sea",
  journalWxLevelVeryRough: "Very rough sea",
  ...
  iciJournalTab:      "Log",
  iciSectionLeg:      "Leg",
  iciSectionAlerts:   "Alerts",
  iciSectionHere:     "Here",
  iciSectionAround:   "Around the boat",
  iciSectionSources:  "Sources",
  iciLegDay:          "D{n}",
  iciLegKn:           "{kn} kn",
  iciLegRemaining:    "{nm} nm left",
  ...
  routeLegOne:        "leg",
  routeLegsShort:     "legs",
  routeEscaleOne:     "port of call",
  routeEscalesShort:  "ports of call",
  routeSeaShort:      "sea",
  routeLandShort:     "land",
  ...
  replayStart: "Replay the expedition",
  replayStartTitle: "Replay the route from Saint-Maur to today, told day by day",
  replayStop: "Stop",
  replayStopTitle: "Stop the film and return to Follow",
  replayProgress: "Replay: {pct} %",
  replayVoiceOn: "Replay voice on (the story is read at each leg)",
  replayVoiceOff: "Replay voice off",
  replayBadge: "Replay",
  ...
  recomputeConstraintsSkipper: "Under the skipper's orders: wind < {wind}, sea < {hs} — no step of the route in those conditions.",
  recomputeConstraintsDefault: "Without skipper's orders: only a sea ≥ {hs} is avoided.",
  drawingInProgress: "Drawing in progress",
  drawingPoints: "points placed",
  drawingFailedSegments: "segment(s) without a sea route",
  drawingRouting: "routing…",
  drawPointLabel: "Point",
  drawingUndoLast: "Undo the last point",
  planReviewTitle: "Plan review",
  planReviewLoading: "reading…",
  planReviewError: "unavailable",
  planReviewAlerts: "alert(s)",
  planReviewWatch: "to watch",
  ...
  planAdviceViaSouth: " via the south corridor",
  planAdviceExtraNm: " (+{nm} nm)",
  planAdviceCascadeLater: "later stops shift later by {days} days",
  planAdviceCascadeEarlier: "later stops shift earlier by {days} days",
  planAdviceCascadeNone: "no shift of later stops",
  planAdvicePillAlerts: "{before} → {after} alerts",
  planAdvicePillNm: "{signed} nm",
  planAdvicePillDays: "{signed} d",
  planCompareToday: "today",
  planCompareAdvised: "advised",
  planCompareDistance: "{nm} nm",
  planCompareSeaDays: "{n} d at sea",
  planCompareAlerts: "{n} alerts",
  planCompareStop: "{stop}: {date}",
  etaRange: "arrival between {p10} and {p90}",
  ...
  filmFullscreen:   "Film fullscreen",
  filmFullscreenExit: "Exit fullscreen",
  filmFullscreenTitle: "Hide the side panels so the map fills the screen. Escape or click again to restore them.",
  ...
  regimeTooltipHindcast: "hindcast: what the boat actually met",
  regimeTooltipForecast: "forecast: 10 days ahead",
  regimeTooltipClimatology: "climatology: monthly average beyond",
  voyageTwa:        "TWA {deg}°",
  ...
  recomputeButton:  "Ask for advice",
