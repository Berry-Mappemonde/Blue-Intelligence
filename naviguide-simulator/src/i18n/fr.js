...
export default {
  ...
  journalKindClimo:    "Changement de régime",
  journalKindSci:      "Station croisée",
  journalKindNews:     "Veille",
  journalClimoRose:    "Le vent dominant a tourné de {deg}°",
  journalClimoCalms:   "Passage aux calmes (vent moyen {kn} kn)",
  journalClimoCycloneIn: "Entrée en saison cyclonique",
  journalClimoCycloneOut: "Sortie de saison cyclonique",
  journalSciNearby:    "Station scientifique croisée : {name} ({nm} nm)",
  journalWxHours:      "{h} h",
  journalWxMax:        "max {n}",
  journalWxLevelRough: "Mer forte",
  journalWxLevelVeryRough: "Mer très forte",
  ...
  iciSectionLeg:      "Étape",
  iciSectionAlerts:   "Alertes",
  iciSectionHere:     "Ici",
  iciSectionAround:   "Autour du bateau",
  ...
  routeLegOne:        "étape",
  routeLegsShort:     "étapes",
  routeEscaleOne:     "escale",
  routeEscalesShort:  "escales",
  routeSeaShort:      "mer",
  ...
  replayStart: "Revoir l’expédition",
  replayStartTitle: "Rejouer la route de Saint-Maur à aujourd’hui, racontée jour par jour",
  replayStop: "Stop",
  replayStopTitle: "Arrêter le film et revenir à Suivre",
  ...
  drawingInProgress: "Tracé en cours",
  drawingPoints: "points posés",
  drawingFailedSegments: "segment(s) sans route mer",
  drawingRouting: "route en calcul…",
  drawPointLabel: "Point",
  drawingUndoLast: "Annuler le dernier point",
  planReviewTitle: "Revue du plan",
  planReviewLoading: "lecture…",
  planReviewError: "indisponible",
  planReviewAlerts: "alerte(s)",
  planReviewWatch: "à surveiller",
  ...
  planAdviceViaSouth: " par le corridor sud",
  planAdviceExtraNm: " (+{nm} nm)",
  planAdviceCascadeLater: "toutes les escales suivantes reculent de {days} jours",
  planAdviceCascadeEarlier: "toutes les escales suivantes avancent de {days} jours",
  planAdviceCascadeNone: "aucun décalage des escales suivantes",
  planAdvicePillAlerts: "{before} → {after} alertes",
  planAdvicePillNm: "{signed} nm",
  planAdvicePillDays: "{signed} j",
  planCompareToday: "aujourd'hui",
  planCompareAdvised: "conseillé",
  planCompareDistance: "{nm} nm",
  planCompareSeaDays: "{n} j de mer",
  planCompareAlerts: "{n} alertes",
  ...
  filmFullscreen:   "Plein écran film",
  filmFullscreenExit: "Quitter le plein écran",
  filmFullscreenTitle: "Masquer les panneaux : la carte occupe tout l’écran. Échap ou recliquer pour les rendre.",
  ...
  regimeTooltipHindcast: "hindcast : ce que le bateau a vraiment rencontré",
  regimeTooltipForecast: "prévision : 10 jours devant",
  ...
  recomputeButton:  "Demander conseil",
