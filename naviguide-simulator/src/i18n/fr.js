...
export default {
  ...
  skipperOrdersTitle:     "Ordres du skipper",
  skipperProfileCoastal:  "Côtier",
  skipperProfileCruise:   "Croisière",
  skipperProfileOcean:    "Large",
  skipperSharedClock:     "L’horloge officielle ne change pas. C’est ton skipper qui parle plus ou moins.",
  skipperBoat:            "Bateau",
  ...
  skipperHorizon:         "Horizon Suivre",
  skipperHorizonLeg:      "cette jambe (Simulation)",
  skipperGale:            "Coup de vent",
  skipperRainSuivre:      "Pluie : {mmh} mm/h ou {mm3h} mm/3 h → repli sous {nm} nm.",
  skipperRainSimulation:  "Pluie et repli : Suivre seulement. Pas de pluie inventée en Simulation.",
